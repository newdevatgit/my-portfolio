...
export default function Hero() {
  return (
    <section
      id="home"
      className="min-h-screen flex items-center justify-center  bg-gray-300  text-white pt-20"
    >
      <div className="max-h-6xl mx-auto px-[10%] py-5 flex flex-col md:flex-row items-center gap-10">
        ...
        <div className="flex-1 text-center md:text-left">
          ...
          <h2 className="text-xl sm:text-2xl mb-6 text-gray-700">
            A Passionate{" "}
            <span className="font-bold text-indigo-400">Web Developer</span>
          </h2>
