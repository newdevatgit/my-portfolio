...
const ProjectCard = ({ title, description, imageUrl, tags, githubUrl, liveUrl }) => (
    <div 
      className="bg-white dark:bg-gray-200 p-4 rounded-2xl shadow-xl overflow-hidden transform hover:-translate-y-1 transition-all duration-300 border border-indigo-100 dark:border-indigo-400 hover:shadow-2xl"
    >
        <img 
          src={imageUrl} 
          alt={title} 
        ...
        />
        <div className="p-6">
            <h3 className="text-2xl font-bold text-black dark:text-gray-900 mb-2">{title}</h3>
            <p className="text-gray-700 dark:text-gray-600 mb-4">{description}</p>
            ...
            <div className="flex gap-4">
                <a 
                    ...
                    className="inline-flex items-center gap-2 w-full justify-center 
                               ...
                               font-semibold px-4 py-2 rounded-lg transition-colors shadow-sm"
                >
